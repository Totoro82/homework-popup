...
//            Arrays.sort(suffixArray, Comparator.comparing(cadena::substring));
            ...
            // LCP Array: lcp[i] = cuantas letras comparten suffixArray[i] y suffixArray[i+1]
            // Si dos sufijos consecutivos tienen un LCP alto, el string original contiene
            // un mismo trozo de texto que aparece en dos posiciones distintas.
            // El substring compartido es: cadena.substring(suffixArray[i], suffixArray[i] + lcp[i])
